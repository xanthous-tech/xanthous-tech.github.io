---
layout: post
title: Elastic Search 调优笔记
lang: zh
author: alexzhao
date: Aug 6, 2019 at 4:22:43 PM
timetoread: 5
draft: false
excerpt: 用户提供了一段原始的查询请求参数，根据原始的请求参数调整为期待的结果，比如在查询“比亚迪年报”时候，最先出现的是关于比亚迪年报点评的结果。
tags: 
  - elasticsearch
---
> 用户提供了一段原始的查询请求参数，根据原始的请求参数调整为期待的结果，比如在查询“比亚迪年报”时候，最先出现的是关于比亚迪年报点评的结果。
